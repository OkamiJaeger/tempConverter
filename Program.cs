...
namespace tempConverter
{
    class temps
    {
        public static void Main(string[] args)
        {
            ...
            do
            {
                try
                {
                    ...
                    while (!int.TryParse(numberToConvert, out intNumToConvert) && !double.TryParse(numberToConvert, out dblNumToConvert))
                    {
        ...
        private static void convertTemp(int intNumToConvert)
        {
            ...
            {
                Console.WriteLine("Couldn't convert temperature.");
                Console.WriteLine(e.Message);
            }
            ...
            finally
            {
                ...
                {
                    Console.WriteLine("Temperature couldn't be converted due to an error.");
                }
